...
fig = plt.figure(3)
ax = fig.add_subplot(1, 1, 1)
DecisionBoundaryDisplay.from_estimator(Mdl1, df1, grid_resolution=1000, plot_method='contour', ax=ax,
                                       levels=[-1, 0, 1], colors='black')
scatter = ax.scatter(df1[var1[0]], df1[var1[1]], c=T1, s=30, cmap='viridis', edgecolors='black')
ax.scatter(Mdl1.support_vectors_[:, 0], Mdl1.support_vectors_[:, 1], s=150, facecolors='none', edgecolors='black')
...
fig = plt.figure(4)
ax = fig.add_subplot(1, 1, 1)
DecisionBoundaryDisplay.from_estimator(Mdl2, df2, grid_resolution=1000, plot_method='contour', ax=ax,
                                       levels=[-1, 0, 1], colors='black')
scatter = ax.scatter(df2[var2[0]], df2[var2[1]], c=T2, s=30, cmap='viridis', edgecolors='black')
ax.scatter(Mdl2.support_vectors_[:, 0], Mdl2.support_vectors_[:, 1], s=150, facecolors='none', edgecolors='black')
ax.legend(*scatter.legend_elements(), loc='upper right', title='Classes')
