...
coef1 = df1.corr()
plt.figure(1)
sns.heatmap(coef1, annot=True, cmap='coolwarm', fmt='.2f', xticklabels=labels, yticklabels=labels,
            annot_kws=dict(fontsize=10))
plt.xticks(rotation=30)

plt.figure(2)
coef2 = df2.corr()
sns.heatmap(coef2, annot=True, cmap='coolwarm', fmt='.2f', xticklabels=labels, yticklabels=labels,
            annot_kws=dict(fontsize=10))
plt.xticks(rotation=30)
