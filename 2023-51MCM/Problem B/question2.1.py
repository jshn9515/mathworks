...
# Seems like the time series donesn't have a trend.
...
plt.savefig('data/问题2-G-V城市对快递运输量图.svg', dpi=300)
...
plt.savefig('data/问题5-G-V城市对快递运输量FFT图.svg', dpi=300)
...
fig.savefig('data/问题2-ACF与PACF图.svg', dpi=300)
...
fig.savefig('data/问题2-ARIMA模型诊断图.svg', dpi=300)
...
plt.subplots_adjust(left=0.08, bottom=0.05, right=0.95, top=0.95)
plt.savefig('data/问题2-ARIMA模型预测图.svg', dpi=300)
